...
(function(a){
    a.fn.amazon_scroller=function(p){
        ...
        dom.find("ul:first").children("li").children("mod_reviews_entry").css("width",m).css("height",n);
        if(h=='enable'){
            dom.find("ul:first").children("li").children("mod_reviews_entry").each(function(){
        ...
        begin();
        s=setTimeout(play,g);
        dom.find("#scroller-nav-left").click(function(){
            previous()
        });
        dom.find("#scroller-nav-right").click(function(){
            next()
        });
        dom.hover(
            function(){
        ...
        function begin(){
            ...
            v=dom.find("ul:first").children("li").outerHeight();
